...
<div class="main-container container-fluid">
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <!-- Page Body -->
            <div class="page-body">
                <h4></h4><?php echo  Yii::$app->session->getFlash('shuaixuanok');
                ?></h4>
                <button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon">

                    <i class="fa fa-plus"><a href=""> 新增参数</a></i>
                </button>
                <div class="row">
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <?php foreach ($data as $v):?>
                                            <tr>
                                                <td align="center"><?php echo str_repeat("|---",$v['level']).$v['category_name'].($v['category_id']) ?></td>
                                                <td align="center"><?php?></td>

                                                <td align="center">
                                                    <a href="<?php echo Url::to(['category/shuaixuan','category_id'=>$v['category_id']]) ?>" class="btn btn-primary btn-sm shiny">
                                                        <i class="fa fa-edit"></i> 筛选条件
                                                    </a>
                                                    <a href="<?php echo Url::to(['type/add','attr_name'=>$v['category_name']]) ?>" class="btn btn-primary btn-sm shiny">
                                                        <i class="fa fa-edit"></i> 编辑
                                                    </a>
                                                    <a href="#" onClick="warning('确实要删除吗', <?php echo Url::to(['type/add','attr_name'=>$v['category_name']]) ?>)" class="btn btn-danger btn-sm shiny">
