                    ...
                    <div class="widget">
                        ...
                        <div id="horizontal-form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-offset-1 col-sm-10">
                                    <?=$form->field($model,'attr_type')->textInput()->dropDownList([0=>'参数',1=>'规格'])?>
                            ...
                            <div class="col-sm-offset-1 col-sm-10">
                                <?=$form->field($model, 'attr_may_value')->textarea(['rows'=>3]) ?>
                            ...
                            <?=$form->field($model, 'goods_type_id')->hiddenInput(['value'=>$_GET['goods_type_id']]) ?>
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <?= Html::submitButton('新增参数', ['class' => 'btn btn-default']) ?>
