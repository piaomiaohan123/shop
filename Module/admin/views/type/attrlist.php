        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon">
                    <i class="fa fa-plus"><a href="<?php echo Url::to(['type/addattr','goods_type_id'=>$_GET['goods_type_id']]) ?>"> 新增参数</a></i>
                </button>
                <div class="row">
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <?php foreach ($data as $v):?>
                                            <tr>
                                                ...
                                                <td align="center"><?php echo str_replace(PHP_EOL,'、',$v->attr_may_value); ?></td>
                                                <td align="center"><?php   if ($v->attr_type==0) {
                                                        echo "参数";
                                                    }else{
                                                        echo "规格";
                                                        }
                                                    ?></td>
                                                <td align="center">
                                                    <a href="<?php echo Url::to(['type/attrlist','attr_name'=>$v->attr_name]) ?>" class="btn btn-primary btn-sm shiny">
                                                        <i class="fa fa-edit"></i> 参数
                                                    </a>
                                                    <a href="<?php echo Url::to(['type/add','attr_name'=>$v->attr_name]) ?>" class="btn btn-primary btn-sm shiny">
                                                        <i class="fa fa-edit"></i> 编辑
                                                    </a>
                                                    <a href="#" onClick="warning('确实要删除吗', <?php echo Url::to(['type/add','attr_name'=>$v->attr_name]) ?>)" class="btn btn-danger btn-sm shiny">
